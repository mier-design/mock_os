...
$root_path = $_SERVER['DOCUMENT_ROOT'] . "/open_data";
...
<form action="" method="post">
        ...
        <table class="table table-bordered table-hover table-sm <?php echo $tableTheme; ?>" id="main-table">
            ...
            ?>
                <tr>
                    ...
                    <td data-order="a-<?php echo $date_sorting; ?>"></td>
            ...
            ?>
                <tr>
                        ...
                        <div class="filename">
                            ...
                            if (in_array(strtolower(pathinfo($f, PATHINFO_EXTENSION)), array('gif', 'jpg', 'jpeg', 'png', 'bmp', 'ico', 'svg', 'webp', 'avif'))) : ?>
                                ...
                                <?php else : ?>
                                    ...
                                    <p><?php echo ($is_link ? ' &rarr; <i>' . readlink($path . '/' . $f) . '</i>' : '') ?></p>
                                    <p><?php echo $modif ?></p>
                        </div>
                    </td>
                    ...
                    <td data-order="b-<?php echo $date_sorting; ?>"></td>
    ...
    <div class="row">
        <?php if (!FM_READONLY) : ?>
            <div class="col-xs-12 col-sm-9 main-nav">
...
?>
    <nav class="navbar navbar-expand-lg <?php echo $getTheme; ?> mb-4 <?php echo $isStickyNavBar ?>">
    ...
    <head>
        ...
        if (FM_THEME == "dark") : ?>
            <style>
                :root {
                    --bs-bg-opacity: 1;
                    --bg-color: #109edc !important;
                    --bs-dark-rgb: 16, 158, 220 !important;
                    --bs-bg-opacity: 1;
                }
